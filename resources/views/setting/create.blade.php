    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form type="" method="post" action="{{route('centers.store')}}">
                    @csrf
                    <label>
                        <input placeholder="center name" name="name" value="">center name
                    </label>
                    <br> <br>
                    <label>
                        <input placeholder="Manager name" name="manager_name" value="">ManagerName
                    </label>
                    <br>
