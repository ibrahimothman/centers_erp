                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="get" action="{{url('/course_groups')}}">
                            ...
                            <!--det-->
                                ...
                                <div class="row cont-det"   id="test1">
                                    <div class="col-md-12">
                                        ...
                                        <span  class=" float-left">{{$course->name}}
                                            <a href="{{url('/courses/'.$course->id)}}" >
                                                <i class="fas fa-info-circle"></i></a> </span>
                                                <span  class=" float-right">
                                            <a href="course_groups/create" class="btn btn-success btn-sm ">
                                                    ...
                                                    <table class="table table-striped w-100">
                                                        ...
                                                        @if(isset($course->groups))
                                                            @foreach($course->groups as $group)
                                                                    <td> {{$Utility->getDate($group->start_at)}} </td>
                                                                    <td >

                                                                        <a href="course_enrollment/create?id={{ $course->id }}"  class="btn btn-outline-warning  btn-sm">
                                                                            <i class="fas fa-plus"></i>
                                                                            <SPAN>تسجيل الطلاب</SPAN> </a>
                                                                        <a  href="course_enrollment"  class="btn btn-outline-success   btn-sm ">
                                                                            <SPAN> الطلاب المسجلين</SPAN>
                                                                        </a></td>
                                                                    <td>
                                                                        <form method="post" action="{{route('course_groups.destroy',$group->id)}}">
                                                                            @csrf
                                                                            @method('delete')
