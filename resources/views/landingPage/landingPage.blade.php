            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-6 col-md-6">
                    <div class="illastrator_png">
                        <img src="\img\edu_ilastration.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-5 ml-auto pl-lg-5">
                ...
                <a href="" class=" learnMore mb-5">learn more</a>
            </div>
            <div class="col-lg-6" data-aos="fade-right">
                <img src="img\undraw_posting_photo.svg" alt="Image" class="img-fluid">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6  mt-lg-0 mt-sm-5  mt-4">
                    <h3 class="text-light mb-3">     About</h3>
                    <p>
                ...
                <div class="col-lg-4  mt-lg-0 mt-sm-5 mt-4">
                    <h3 class="text-light mb-3">   Contact Us</h3>
                    <p>
                        200, D-block, Green lane USA <br>
                        +10 367 467 8934 <br>
                    </p>
                </div>
                <div class="col-lg-2  mt-lg-0 mt-sm-5 mt-4">
                    <h3 class="text-light mb-3"> Follow us</h3>
            ...
            <div class="copyright text-center text-light my-auto pt-3">
