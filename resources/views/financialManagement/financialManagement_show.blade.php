                    ...
                    <div class="card mb-4 shadowed">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card   mb-3" style="max-width: 100%; ">
                                ...
                                <ul class="menu">
                                    <li>
                                        <button class="item  btn btn-light " id="allShow">الكل</button>
                                    </li>
                                    <li>
                                        <button class="item btn btn-light " id="profitShowBtn"> الارباح</button>
                                    </li>
                                    <li>
                                        <button class="item  btn btn-light " id="revenuesShow">الايرادات</button>
                                    </li>
                                    <li>
                                        <button class="item btn btn-light " id="outlayShow"> المصروفات</button>
                                    </li>
                                    <li>
                                        <button class="item  btn btn-light " id="payrollShow">الرواتب</button>
                                    </li>
                                    <li>
                                        <button class="item  btn btn-light " id="details">تفاصيل الارباح والطباعه
                                        </button>
                                    </li>
                                </ul>
                                <!-- end nav -->
                                ...
                                <div class="">
                                    <div class="btn-group print-btn p-3 ">
                                        <button type="button" class="btn btn-success float-right " data-toggle="modal"
                                                data-target="#formDate">اختيار مده محدده
                                        </button>
                                    </div>
                                </div>
                                <!-- view section 1 -->
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 ">
                                                            ...
                                                            <input type="number" name="expenses" id="expenses"
                                                                   class="form-control"
                                                                   value="{{ $results['finance']["expenses_amount"] }}"
                                                                   readonly/>
                                                        </div>
                                                        <div class="col-sm-6 ">
                                                            ...
                                                            <input type="number" name="revenues" id="revenues"
                                                                   class="form-control"
                                                                   value="{{ $results['finance']['revenues_amount'] }}"
                                                                   readonly/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group title">
                                                        <div class=" col-sm-6">
                                                            ...
                                                            <input type="number" name="netProfit" id="netProfit"
                                                                   class="form-control"
                                                                   value="{{ $results['finance']['net_profit'] }}"
                                                                   readonly/>
                                                        </div>
                                                        <div>
                                                            <button class="btn btn-success mt-4 " id="showBtn"> عرض
                                                                التفاصيل
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card border-primary p-3 ">
                                                        ...
                                                        <div class="btn-group ">
                                                            <div class="btn-group search-panel ">
                                                                <button type="button"
                                                                        ...
                                                                        aria-expanded="false">
                                                                    <span id="search_concept">البحث فى </span> <span
                                                                            class="caret"></span>
                                                                </button>
                                                            ...
                                                            <input type="text" class="form-control " id="search"
                                                                   placeholder="ابحث">
                                                            <div class="btn-group">
                                                                <button class="btn btn-success" id="search"><i
                                                ...
                                                <div class="card-body ">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button type="button"
                                                                                            ...
                                                                                            data-toggle="modal"
                                                                                            data-target="#printModalRevenues">
                                                    ...
                                                    <div class="row form-group">
                                                        <h5 class="text-warning ">الايرادات: </h5>
                                                        <div class="col-sm-4">
                                                            <input type="number" value="{{ $revenue }}" name="sum"
                                                                   id="sum" class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card border-primary p-3 ">
                                                <div class="card-header text-primary bg-transparent border-primary ">
                                                    ...
                                                    <form class="form-inline fLeft ">
                                                        <input type="search" class="form-control"
                                                               placeholder="البحث بالفاتوره" list="pill">
                                                        <datalist id="pill">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row form-group">
                                                        <h5 class="text-warning ">المصروفات: </h5>
                                                        <div class="col-sm-4">
                                                            <input type="number" name="sumOutlaySow" id="sumOutlaySow"
                                                                   value="{{ $total_expenses }}" class="form-control"
                                                                   readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="section-4">
                                    <div class="row mb-3">
                                        <div class="col-sm-12">
                                            <div class="card border-primary p-3 ">
                                                <div class="card-header text-primary bg-transparent border-primary ">
                                                    <h5 class="fRight"> مرتبات المدربين</h5>
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="number" value="{{ $total_salaries }}"
                                                                   name="sumPayrollSow" id="sumPayrollSow"
                                ...
                                <div id="section-5">
                                    <div class="row mb-3">
                                        <div class="col-sm-12">
                                            <div class="card border-primary p-3 ">
                                                <div class="card-header text-primary bg-transparent border-primary ">
                                                    <h5 class="fRight"> مرتبات الموظفين</h5>
                                                                    ...
                                                                    @foreach($results['transactions'] as $result)
                                                                        @foreach($result['transactions']->filterByAccount(5, false) as $transaction)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button type="button"
                                                                                            name="printPayrollEmployee"
                                                                                            class="btn btn-warning form-control"
                                                                                            data-toggle="modal"
                                                                                            data-target="#printModalPayrollEmployee">
                                                                                        <i class="fa fa-print   px-2"> </i>
                                                                                    </button>
                                                                                </td>
                                                                            </tr>
...
<!-- print -->
<!-- Central Modal Small -->
<div class="modal fade" id="printModalRevenues" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    ...
    <div class="modal-dialog " id="modalForPrint" role="document">
        ...
        <div class="modal-content " id="contentForPrint">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success  dismiss" id="print-revenues"><i
                            class="fa fa-print   px-2"> </i>طباعه
                </button>
                <button type="button" class="btn btn-danger  print" data-dismiss="modal">الغاء</button>
            </div>
        </div>
...
<!-- print pill -->
<!-- Central Modal Small -->
<div class="modal fade" id="printModalPill" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    ...
    <div class="modal-dialog " id="modalForPrint" role="document">
        ...
        <div class="modal-content " id="contentForPrint">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success  dismiss" id="print-expenses"><i
                            class="fa fa-print   px-2"> </i>طباعه
                </button>
                <button type="button" class="btn btn-danger  print" data-dismiss="modal">الغاء</button>
            </div>
...
<div class="modal fade" id="printModalPayroll" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog " id="modalForPrint" role="document">
        ...
        <div class="modal-content " id="contentForPrint">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success  dismiss" id="print-payroll"><i
                            class="fa fa-print   px-2"> </i>طباعه
                </button>
                <button type="button" class="btn btn-danger  print" data-dismiss="modal">الغاء</button>
            </div>
...
<!-- end print -->
<!--------------------------------------------- print payroll employee ---------------------------- -->

<!-- Central Modal Small -->
<div class="modal fade" id="printModalPayrollEmployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    ...
    <div class="modal-dialog " id="modalForPrint" role="document">
        ...
        <div class="modal-content " id="contentForPrint">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success  dismiss" id="print-payroll-employee"><i
                            class="fa fa-print   px-2"> </i>طباعه
                </button>
                <button type="button" class="btn btn-danger  print" data-dismiss="modal">الغاء</button>
            </div>
