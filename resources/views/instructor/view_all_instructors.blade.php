                ...
                <div class="col-sm-12">
                    <div class="card mb-4">
                        <div class="card-header text-primary ">
                            <h3 class="float-left"> المدربين</h3>
                            <a href="">
                                <button type="button" class="btn btn-success float-right ">اضافه بيانات مدرب</button>
                            </a>
                        </div>
                        <!-- nav -->
                        <div class="container  ">
                                                        ...
                                                        <div class="card motionCard">
                                                            <div class="card-body text-center">
                                                              ...
                                                              {{--  <p class="card-text">{{$instructors[$j]->bio}}</p>--}}
                                                                ...
                                                                <a href="/instructors/{{$instructors[$j]->id}}" class="btn btn-outline-success  py-1 px-2 m-1"><i class="fas fa-eye m-0"></i></a>
