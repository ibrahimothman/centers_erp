...
//    {
//        echo Utility::datePassed(Utility::getDate($this->times[0]->day),$this->times[0]->end);
//        if (Utility::datePassed(Utility::getDate($this->times[0]->day),$this->times[0]->end)){
//            $this->attributes['opened'] = 0;
//        }
//    }
